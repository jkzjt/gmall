...
public class OrderInfo implements Serializable {
    ...
    public String getTradeBody(){
        ...
        String template = "%s ×%s | ";
        System.out.println(String.format(template, "小米", 1));
        StringBuilder tradeBody = new StringBuilder();
        for (OrderDetail orderDetail : orderDetailList) {
            tradeBody.append(String.format(template, orderDetail.getSkuName(), orderDetail.getSkuNum()));
        }
        return tradeBody.toString();
    }
